...
import BountyProfile from '../components/features/BountyProfile';
...
export default function Settings() {
  ...
  const handleTelegramTest = async () => {
    ...
    try {
      ...
      setTelegram(prev => ({ ...prev, testing: false, testResult: data.ok ? 'success' : 'error' }));
    } catch {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white">Bounty Profile</h2>
              <p className="text-sm text-gray-400">
                Earn points and badges by reporting DeFi threats to the community
              </p>
            </div>
          </div>
          <BountyProfile />
        ...
        <Card>
          ...
          <p className="text-gray-400 text-sm mb-5">
            ...
            <a href="https://t.me/BotFather" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">@BotFather</a> and your chat ID from{' '}
            <a href="https://t.me/userinfobot" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">@userinfobot</a>.
          </p>
          <div className="space-y-4">
            <div>
            ...
            <div className="flex gap-3">
              <Button onClick={handleTelegramTest} variant="secondary" className="flex-1"
        ...
        <Card>
          ...
          <div className="space-y-2">
            ...
            {SUPPORTED_NETWORKS.map(key => (
              <button key={key} onClick={() => switchNetwork(key as NetworkKey)}
            ...
            {(Object.entries(CONTRACT_ADDRESSES[currentNetwork]) as [string, string][]).map(([label, address]) => (
              <div key={label} className="bg-gray-800/50 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  {address && (
                    <a href={getExplorerUrl(currentNetwork, 'address', address)} target="_blank"
                      rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 text-sm shrink-0">
                      View →
                    </a>
                  )}
                </div>
        ...
        <Card>
          ...
          <div className="mt-4 pt-4 border-t border-gray-700 flex gap-4 text-sm">
            <a href="https://github.com/Ted1166/GuardDog" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">GitHub →</a>
            <a href="https://guard-dog.vercel.app" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">Live App →</a>
            <a href="https://x.com/guarddog_ai" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">Twitter →</a>
          </div>
        </Card>
        ...
        <Card className="border-red-500/30">
          ...
          <div className="bg-red-500/10 rounded-lg p-4">
            ...
            <Button variant="danger" onClick={handleClearAll}>Clear All Data</Button>
          </div>
        </Card>
